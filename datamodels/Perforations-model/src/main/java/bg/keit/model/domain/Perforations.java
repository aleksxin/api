...
public class Perforations implements java.io.Serializable {
	...
	@JoinColumns({
			@JoinColumn(
					...
					referencedColumnName = "MACHINE_ID", insertable = false, updatable = false),
			@JoinColumn(
					name = "JOB_ID", nullable = false,
					referencedColumnName = "JOB_ID", insertable = false, updatable = false)
	})
	private Jobs jobs;
	@ManyToOne
	...
	@Column(name = "EXECUTION_USER", length = 4000)
